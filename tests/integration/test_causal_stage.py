...
A case with no causal payload (e.g. AI-issuance) runs the existing path unchanged.
A case carrying a causal payload (e.g. French-banks) gets exactly one main_theme + one
chain attached, every theme-node operational, edges tagged inferred/feedback.
"""
