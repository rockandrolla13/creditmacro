...
| [Tracing Value-Added and Double Counting in Gross Exports](https://www.nber.org/papers/w18579) | Koopman, Wang & Wei · 2014 | AER 104(2) 459–94 · paper | CAUSAL/SYSTEM → global input-output network (regional-sector nodes, value-added-flow edges); shock a node → solve downstream impairment across unlisted suppliers | preprint open · **Y** | The canonical gross-exports value-added decomposition behind global IO-network shock propagation *(PDF in `research/global-io-network/`)* |
...
| Title | Authors · Yr | Venue · Type | Stage → primitive | Access · Canon | Why it clears the bar |
|---|---|---|---|---|---|
| [A New Approach to the Economic Analysis of Nonstationary Time Series](https://www.jstor.org/stable/1912559) | Hamilton · 1989 | Econometrica 57(2) 357–84 · paper | CONTEXT → HMM/Markov-switching: map conflicting data into an unobserved state-probability vector (has the economy crossed a phase threshold?) | paywalled · **Y** | The canonical regime-switching reference *(1989 paper paywalled; Hamilton's open method survey "Regime-Switching Models" PDF in `research/macro-regime/`)* |
...
| [Forecasting Using Principal Components From a Large Number of Predictors](https://www.princeton.edu/~mwatson/papers/Stock_Watson_JASA_2002.pdf) | Stock & Watson · 2002 | JASA 97(460) 1167–79 · paper | CONTEXT → dynamic-factor model (DFM): extract one latent signal from hundreds of asynchronous, misaligned series (real-time nowcasting) | **open (PDF)** · **Y** | Foundational DFM; the math behind real-time macro nowcasting *(PDF in `research/macro-regime/`)* |
| [The Narrow Corridor: States, Societies, and the Fate of Liberty](https://www.penguinrandomhouse.com/books/555400/the-narrow-corridor-by-daron-acemoglu-and-james-a-robinson/) | Acemoglu & Robinson · 2019 | Penguin · book | CONTEXT → political-economy hysteresis + structural policy-regime shifts as boundary conditions on the state-space tracker | paywalled · N | Influential synthesis — **commercial book, no open PDF; cite the mechanism, not a backtest** (no local copy redistributed) |
