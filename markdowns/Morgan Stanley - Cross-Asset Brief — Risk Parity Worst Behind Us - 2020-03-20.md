_March 20, 2020 06:01 PM GMT_ 

## **Cross-Asset Brief | Global** 

## Risk Parity: Worst Behind Us 

We estimate that a rise in cross-asset volatility and correlation has driven sharp deleveraging in risk parity portfolios. From here, we think equity allocations have less room to fall. 

## **We estimate risk parity portfolios' historically extreme derisking over the last** 

**four weeks:** We estimate risk parity dynamics for a simple bond-equity portfolio. Risk parity has experienced a sharp portfolio deleveraging (2.0x in December to 1.1x now) as both equity and rates volatility have spiked. Equity had close to the largest four-week outflow (~51MM per 100MM notional portfolio). Rates also had a large four-week outflow (~57MM). This deleveraging may help to explain the unusual recent correlation between stocks and bonds, which has only put more deleveraging pressure on risk parity. 

**Equity exposure close to all-time lows:** The large spike in equity volatility has pushed the allocation to equities in our simple risk parity model near to an alltime low. Taking into account the reduced leverage and lower equity weight, a 100MM notional of our risk parity portfolio has just 21MM equity exposure (from ~80MM a month ago). 

**Rates exposure also drops but less extreme:** Despite the high rates relative weight, the portfolio-level deleveraging has meant rates exposure per 100MM of portfolio has also dropped to 87MM (from ~145MM a month ago), which is below average but not close to the all-time lows. 

|MORGAN STANLEY & CO. INTERNATIONAL PLC+<br>Phanikiran L Naraparaju|MORGAN STANLEY & CO. INTERNATIONAL PLC+|
|---|---|
|STRATEGIST||
|Phanikiran.Naraparaju@morganstanley.com<br>Wanting Low<br>STRATEGIST|+44 20 7677-5065|
|Wanting.Low@morganstanley.com|+44 20 7425-6841|
|Andrew Sheets<br>STRATEGIST||
|Andrew.Sheets@morganstanley.com|+44 20 7677-2905|
...
Cross-Asset Playbook: Brace for Recession (17 Mar 2020) 

Cross-Asset Dispatches: Too Far, Too Fast – Add Some Exposure (13 Mar 2020) 

Cross-Asset Brief: What Happens When the Hedge Doesn't Work (12 Mar 2020) 

**Stock-bond correlation is one to watch:** While the large spike in volatility has been the primary driver of deleveraging recently, we note that stock-bond correlations have become less negative in recent days, a potential driver of more deleveraging if it persists. That said, we think the incremental deleveraging from this will be modest. 

## **The worst of the risk parity outflows is likely behind us, especially for stocks:** 

We see incremental outflows being smaller and/or spread out, especially for stocks. Rates have low risk from deleveraging but remain vulnerable to a switch out of bonds into stocks as equity volatility eases relative to rates. 

**Exhibit 1:** Collective rise in volatility drives risk parity deleveraging 

**==> picture [317 x 116] intentionally omitted <==**

**----- Start of picture text -----**<br>
Portfolio Leverage Leverage<br>3.5<br>Median<br>3.0<br>2.5<br>2.0<br>1.5<br>1.0 1.1<br>ahora al<br>0.5<br>0.0<br>Jan-95 Jan-00 Jan-05 Jan-10 Jan-15 Jan-20<br>Source: Bloomberg, Morgan Stanley Research; Note: Based on hypothetical US$100MM fund rebalanced weekly using trailing 6m volatility,<br>targeting 8% volatility level.<br>**----- End of picture text -----**<br>
...
The spike in volatility across asset classes has driven sharp deleveraging in risk parity portfolios. **But the speed of the move and resultant deleveraging makes us believe that the worst of the risk parity outflows is likely behind us, especially for stocks.** We see incremental outflows being smaller and/or spread out. Bonds have low risk from deleveraging at the portfolio level but remain vulnerable to a reversal out of bonds into stocks as equity volatility eases relative to rates. 

While there are many ways to construct risk parity portfolios (number of assets, lookback periods for volatility/correlations and rebalancing frequencies), we use a simple two-asset risk parity portfolio of equities and bonds to illustrate the impact of changing volatility and correlation trends. We use a trailing 6m lookback period to measure volatility and correlation and rebalance the portfolio on a weekly basis. This illustrative portfolio leverage dropped from around 2.0x in December to 1.1x now, one of the sharpest deleveraging in the last 25 years. The volatility spike has been the primary driver of dual derisking across both equity and rates. This deleveraging may help to explain the unusual recent correlation between stocks and bonds, which has only put more deleveraging pressure on risk parity. 

## **That said, correlations have been less of a problem so far as the negative equity-bond** 

**correlations have persisted** (looking back over 10 months). If bond-equity correlations were to go to 0 from very negative levels, there might still be further deleveraging, but the magnitude is likely to be much smaller than the impact from the volatility spike. 

**Exhibit 2:** Risk parity leverage has dropped **Exhibit 3:** Equity weight close to the lows as sharply due to the spike in volatility equity vol spike has been high relative to bonds 

**==> picture [167 x 104] intentionally omitted <==**

**----- Start of picture text -----**<br>
Portfolio Leverage Leverage<br>3.5<br>Median<br>3.0<br>2.5<br>2.0<br>1.5<br>1.0 1.1<br>0.5<br>0.0 — [ot] ar<br>Jan-95 Jan-00 Jan-05 Jan-10 Jan-15 Jan-20<br>Source: Bloomberg, Morgan Stanley Research; Note: Based on<br>hypothetical US$100MM fund rebalanced weekly using trailing 6m<br>volatility, targeting 8% volatility level.<br>**----- End of picture text -----**<br>


**==> picture [157 x 100] intentionally omitted <==**

**----- Start of picture text -----**<br>
Portfolio Wt<br>50% SPX<br>Median<br>45%<br>40%<br>35%<br>30%<br>25%<br>20%<br>15% 20%<br>10% oror<br>Jan-95 Jan-00 Jan-05 Jan-10 Jan-15 Jan-20<br>Source: Bloomberg, Morgan Stanley Research; Note: Based on<br>hypothetical US$100MM fund rebalanced weekly using trailing 6m<br>volatility, targeting 8% volatility level.<br>**----- End of picture text -----**<br>


**Exhibit 4:** Equity-bond correlations moving to zero is a risk 

Source: Bloomberg, Morgan Stanley Research 

**Exhibit 5:** Even if bond-equity correlation went to 0, incremental deleveraging is modest 

**==> picture [166 x 99] intentionally omitted <==**

**----- Start of picture text -----**<br>
Portfolio Leverage<br>3.0 _ Leverage (Zero Correlation)<br>2.5<br>2.0<br>1.5<br>1.0<br>0.8<br>0.5<br>0.0 — [tr]<br>Jan-95 Jan-00 Jan-05 Jan-10 Jan-15 Jan-20<br>Source: Bloomberg, Morgan Stanley Research; Note: Assuming equity-<br>bond correlation is zero throughout. Based on hypothetical US$100MM<br>fund rebalanced weekly using trailing 6m volatility, targeting 8% vol level.<br>**----- End of picture text -----**<br>


2 

## **While the rise in volatility has been universal, the spike in equity volatility has been** 

_**sharper**_ **than for rates:** As a result, the net weight for equity (which is inversely related to the level of volatility) has dropped to just 20%, which is close to the all-time lows. The equity market has consequently been impacted by a double-whammy of deleveraging and allocation out of equity into bonds. 

Taking into account the reduced leverage and lower equity weight, a 100MM notional of our risk parity portfolio has just 21MM equity exposure (from ~80MM a month ago), which is close to the all-time low (of 12MM) set in 2009. Equity had close to the largest four-week outflow (~51MM per 100MM notional portfolio). 2018 was marginally worse due to the much lower starting point for volatility/higher point for leverage. 

Despite the high rates relative weight, the portfolio-level deleveraging has meant rates exposure per 100MM of portfolio has also dropped to 87MM (from ~145MM a month ago), which is below average but not close to the all-time low. Rates also had a large four-week outflow (~57MM), although some of the equity -> bond shift cushioned the deleveraging outflow. The taper tantrum in 2013 was much worse for rates outflow due to the rate vol spike relative to equity. 

**Exhibit 6:** S&P 500 exposure optional close to an all-time low 

**==> picture [166 x 103] intentionally omitted <==**

**----- Start of picture text -----**<br>
USD MM SPXAmt<br>120<br>Median<br>100<br>80<br>60<br>40<br>20 21<br>sect Al<br>0<br>Jan-95Jan-98Jan-01Jan-04Jan-07Jan-10Jan-13Jan-16Jan-19<br>Source: Bloomberg, Morgan Stanley Research; Note: Based on<br>hypothetical US$100MM fund rebalanced weekly using trailing 6m<br>volatility, targeting 8% volatility level.<br>**----- End of picture text -----**<br>


**Exhibit 7:** Rates exposure has dropped sharply as well but is not as extreme 

**==> picture [166 x 103] intentionally omitted <==**

**----- Start of picture text -----**<br>
USD MM USTAmt<br>300<br>Median<br>250<br>200<br>150<br>100 87<br>50<br>Ath a<br>0<br>Jan-95Jan-98Jan-01Jan-04Jan-07Jan-10Jan-13Jan-16Jan-19<br>Source: Bloomberg, Morgan Stanley Research; Note: Based on<br>hypothetical US$100MM fund rebalanced weekly using trailing 6m<br>volatility, targeting 8% volatility level.<br>**----- End of picture text -----**<br>


**Exhibit 8:** One of the largest four-week outflows for the S&P 500... 

**==> picture [168 x 92] intentionally omitted <==**

**----- Start of picture text -----**<br>
S&P 500 4wk Flow Estimate ($bn/100bn AUM)<br>40<br>20<br>0<br>-20<br>-40<br>-60 -51<br>Jan-95 Jan-00 Jan-05 Jan-10 Jan-15 Jan-20<br>Source: Morgan Stanley Research<br>**----- End of picture text -----**<br>


## **Exhibit 9:** ….as well as bonds 

**==> picture [168 x 92] intentionally omitted <==**

**----- Start of picture text -----**<br>
UST 10yr 4wk Flow Estimate ($bn/100bn AUM)<br>60<br>40<br>20<br>0<br>-20 Total ONAL Een Ve Ad on A<br>-40<br>-60<br>-57<br>-80<br>Jan-95 Jan-00 Jan-05 Jan-10 Jan-15 Jan-20<br>Source: Morgan Stanley Research<br>**----- End of picture text -----**<br>
...
While the recent impact on risk parity portfolios has been mainly driven by a large spike in volatility, one should keep in mind that the correlation dynamic is also an important driver of leverage in risk parity portfolios. For a two-asset risk parity portfolio, the usual negative correlation of stocks and bonds suppresses the overall volatility of this bond/equity portfolio and therefore results in _higher_ leverage to meet the vol target. 

This equity-rates correlation has started to become less negative in recent days and, if it persists, it could lead to further deleveraging as portfolio volatility picks up. This is a correlation we are watching to gauge any further outflows in risk parity portfolios. 

**Exhibit 10:** Equity-rates correlations are becoming less negative 

**Exhibit 11:** Bonds are becoming less effective as a hedge 

**==> picture [168 x 84] intentionally omitted <==**

**----- Start of picture text -----**<br>
UST 10Y 1-day Yield Change (bp)<br>40 Mar 17th<br>30 o<br>20 .<br>10 Mar 18th Mar 13th<br>Mar 11th<br>0<br>-10 Mar 12th Mar 19th<br>-20 Mar 16th % ‘ °<br>-30<br>-16% -12% -8% -4% 0% 4% 8% 12%<br>S&P 500 1-day Returns<br>Source: Bloomberg, Morgan Stanley Research<br>**----- End of picture text -----**<br>


Source: Bloomberg, Morgan Stanley Research 

More broadly, we track 6m correlations across asset classes and regions with our correlation monitor (Exhibit 13). Global correlations have spiked higher over the past week, typical of market stress scenarios. Within this, regional correlations, cross-asset correlations and individual stock correlations have all risen simultaneously (see CrossAsset Brief: Correlation Spike, March 3, 2020). Correlations are something we are watching out for to gauge potential deleveraging from risk parity funds. 

**Exhibit 12:** Global cross-asset correlation spiked to historical highs, but has since moderated 

Source: Bloomberg, Morgan Stanley Research; Note: We compute a simple average of pairwise cross-asset and regional 6m correlations. See CrossAsset Brief: Correlation Spike, March 3, 2020, more details on the components. 

4 

**Exhibit 13:** Cross-asset and regional 6m correlations 

Source: Bloomberg, Morgan Stanley Research; Note: *Rates correlations in yield terms here. Black dot represents current correlation. Dark blue shaded box shows interquartile range over the last five years, while light blue box shows 5th to 95th percentile over the last five years. Black line represents 5Y median. 

5 

## **Exhibit 14:** 6m correlations between specific assets 
